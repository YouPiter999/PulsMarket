...
console.log("✅ Monkeypatches applied successfully! Bootstrapping Firebase CLI...");

// Set argv to emulate the command line arguments
process.argv = [
    process.execPath,
    'firebase',
    'deploy',
...
// Require global firebase-tools launcher directly as observed in debug log
